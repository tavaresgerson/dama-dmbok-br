...
O Modelo de Informação de Amsterdã, assim como o Modelo de Alinhamento Estratégico (Abcouwer, Maes e Truijens, 1997),[^13] adota uma perspectiva estratégica sobre o alinhamento de negócios e TI. Conhecido como "9 células", ele reconhece uma camada intermediária que se concentra em estrutura e táticas, incluindo planejamento e arquitetura. Além disso, reconhece a necessidade de comunicação da informação, expressa como o pilar de governança da informação e qualidade dos dados (Figura 4).
